...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6">
            ...
            <img src="{{ asset('images/it-engineer-working-with-his-pc.jpeg') }}" width="580"
...
<script>
    ...
    fetch(url, {
        ...
        messageDiv.innerHTML = '<div class="alert alert-success">Registration was successful. Please check your email for account verification. </div>'
